...
- **Numerals are plain: 1, 2, 3 - never zero-padded 01/02/03.** Step numbers, stage counters, and list numerals render as single digits (owner directive 2026-08-13), in the stat weight (900) when they are the visual anchor.
